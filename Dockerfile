...
RUN add-apt-repository ppa:ondrej/php && apt-get -y update && apt-get install -y --allow-unauthenticated apache2 php5.6 php5.6-intl php-common php5.6-common php5.6-json php5.6-opcache php5.6-readline php5.6-cli \
libapache2-mod-php5.6 libapache2-mod-fcgid apache2-doc apache2-utils php5.6-fpm php5.6-xml php-xdebug php5.6-zip php5.6-mbstring \
php5.6-bcmath php5.6-mysql curl supervisor
